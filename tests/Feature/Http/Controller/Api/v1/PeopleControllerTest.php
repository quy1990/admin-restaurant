...
class PeopleControllerTest extends TestCase
{
    ...
    /**
     * docker exec -it app ./vendor/bin/phpunit --filter non_authenticated_users_cannot_access_the_following_endpoint_for_peoples
     * @test
     */
    public function non_authenticated_users_cannot_access_the_following_endpoint_for_peoples()
    {
